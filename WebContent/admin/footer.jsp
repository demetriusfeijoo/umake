...
<script src="<c:url value="/admin/js/jquery-ui-1.8.23.custom.min.js" />" type="text/javascript"></script>
<script src="<c:url value="/admin/js/codemirror.js" />" type="text/javascript"></script>
<script src="<c:url value="/admin/js/css.js" />" type="text/javascript"></script>
<script lang="javascript" src="<c:url value="/admin/js/functions.js" />" type="text/javascript"></script>
</body>
</html>