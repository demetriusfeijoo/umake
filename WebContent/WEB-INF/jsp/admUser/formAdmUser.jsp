...
<section id="content">
	...
	<form action="<c:url value="/adm/user" />" method="post" id="formAdmUser">
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><label for="email" class="label">E-mail: </label></td>
			...
			<tr>
				<td><label for="receiveEmail" class="label">Gostaria de receber email: </label></td>
				<td>
			...
			<tr>
				<td colspan="2">
					<c:if test="${admUser.id == null}"><button name="_method" class="submit botoes" value="post"></button></c:if>
